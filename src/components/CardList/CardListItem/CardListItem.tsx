  ...
  return (
    <div class="flex flex-col max-w-[330px] min-h-[312px] p-[20px] bg-white">
      ...
      <div class="flex justify-between">
        <span class="text-[#11253E] text-[18px] font-semibold">{props.name}</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="30"
          height="30"
      ...
      <div class="flex justify-between gap-[10px]">
        ...
        <div class="flex flex-col max-w-[100px]">
          ...
          <span class="text-[12px] font-semibold break-words">{props.address.city}</span>
        </div>
      </div>
      <button class="flex justify-center items-center gap-[6px] bg-[#11253E] h-[42px] rounded-md">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="14"
          height="14"
      ...
      <div class="flex flex-col">
        <div class="text-[#8695A7] flex items-center gap-[5px]">
          <span>Контакты</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="12"
